...
<body>
            ...
            <div class="row no-gutters">
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Connecting you with the best candidates to drive your business forward.</p>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Identifying top-tier leaders to guide your organization to success.</p>
                        <!--<a href="#" class="boxed-btn3-white">Apply For a Bed</a>-->
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Providing skilled temporary staff to meet your short-term needs.</p>
                        <!--<a href="#" class="boxed-btn3-white">Apply For a Bed</a>-->
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-55">
                        <h3>Our Services</h3>
                        <p>Empowering Careers Through Exceptional Talent Acquisition and Support. </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            <h3><a href="#">Talent Acquisition</a></h3>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            <h3><a href="#">Executive Search</a></h3>
                            <p>Esteem spirit temper too say adieus who direct esteem.</p>
                            <a href="#" class="learn_more">Learn More</a>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            <h3><a href="#">Temporary Staffing</a></h3>
                            <p>Esteem spirit temper too say adieus who direct esteem.</p>
                            <a href="#" class="learn_more">Learn More</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-10 offset-xl-1">
                            <div class="testmonial_info text-center">
                                ...
                                <p>Innovation at its Core<br>
                                "Innovation distinguishes between a leader and a follower."
                                    <br>
                                    Join a team where creativity and innovation thrive. </p>
                        ...
                        <div class="col-xl-10 offset-xl-1">
                            <div class="testmonial_info text-center">
                                ...
                                "Your career is your business. It's time for you to manage it as a CEO."
                                    <br>
                                    We invest in our employees' growth and development. </p>
                                <div class="testmonial_author">
                                    <h4>Dorit Sher</h4>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-10 offset-xl-1">
                            <div class="testmonial_info text-center">
                                ...
                                <p>Diverse and Inclusive Workplace<br>
                                "Diversity is the art of thinking independently together."
                                    <br>
                                    We believe in the power of diversity and inclusion to drive success. </p>
                                <div class="testmonial_author">
                                    <h4>Malcolm Forbes</h4>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- business_expert_area_end  -->
     ...
     <div class="expert_doctors_area" id="testmonials">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
